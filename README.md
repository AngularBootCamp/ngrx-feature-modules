# Angular Boot Camp example: ngrx-feature-modules
...
**[StackBlitz for ngrx-feature-modules](https://stackblitz.io/github/AngularBootCamp/ngrx-feature-modules)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/ngrx-feature-modules.git
cd ngrx-feature-modules
npm install
npm start
```
